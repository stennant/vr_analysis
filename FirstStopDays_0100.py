...
filename = 'Data_Input/Behaviour_DataFiles/PVCre1_Opto_0100.h5'
...
sd_con_beac = np.nanstd(firststopstorebeac, axis = 1)/math.sqrt(6)
sd_con_nbeac = np.nanstd(firststopstorenbeac, axis =1)/math.sqrt(6)
sd_con_probe = np.nanstd(firststopstoreprobe, axis = 1)/math.sqrt(6)
...
plt.locator_params(nbins=4, axis ='y') # set tick number on y axis
plt.locator_params(nbins=4, axis ='x') # set tick number on x axis
...
plt.subplots_adjust(hspace = .35, wspace = .39,  bottom = 0.3, left = 0.12, right = 0.9, top = 0.92)

fig.savefig('Plots/First_Stops/FirstStops_vsdays_0100'+'.png', dpi =200) # path to save figure to
plt.close()
...
x = np.hstack((firststopstorebeac[:,0],firststopstorebeac[:,1],firststopstorebeac[:,2],firststopstorebeac[:,3],firststopstorebeac[:,4],firststopstorebeac[:,5],firststopstorebeac[:,6],firststopstorebeac[:,7]))
xsd = np.hstack((firststopstorebeac[:,0],firststopstorebeac[:,1],firststopstorebeac[:,2],firststopstorebeac[:,3],firststopstorebeac[:,4],firststopstorebeac[:,5],firststopstorebeac[:,6],firststopstorebeac[:,7]))

x1 = np.hstack((firststopstorenbeac[:,0],firststopstorenbeac[:,1],firststopstorenbeac[:,2],firststopstorenbeac[:,3],firststopstorenbeac[:,4],firststopstorenbeac[:,5],firststopstorenbeac[:,6],firststopstorenbeac[:,7]))
x1sd = np.hstack((firststopstorenbeac[:,0],firststopstorenbeac[:,1],firststopstorenbeac[:,2],firststopstorenbeac[:,3],firststopstorenbeac[:,4],firststopstorenbeac[:,5],firststopstorenbeac[:,6],firststopstorenbeac[:,7]))

x2 = np.hstack((firststopstoreprobe[:,0],firststopstoreprobe[:,1],firststopstoreprobe[:,2],firststopstoreprobe[:,3],firststopstoreprobe[:,4],firststopstoreprobe[:,5],firststopstoreprobe[:,6],firststopstoreprobe[:,7]))
x2sd = np.hstack((firststopstoreprobe[:,0],firststopstoreprobe[:,1],firststopstoreprobe[:,2],firststopstoreprobe[:,3],firststopstoreprobe[:,4],firststopstoreprobe[:,5],firststopstoreprobe[:,6],firststopstoreprobe[:,7]))
...
np.savetxt('Data_Output/FirstStop_Days_0100.csv', data,fmt =  '%i,%i,%i,%10.3f', delimiter = ',', header = 'Mouse, Day, Trialtype, Location (cm)')
