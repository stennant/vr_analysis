...
filename = 'Data_Input/Behaviour_DataFiles/PVCre1_Opto_0100.h5' # raw data files
...
con_beac1_w1 = np.nanmean(np.nanmean(s2_con_firststopstorebeac[0:5,:,:], axis = 0), axis = 0)
con_nbeac1_w1 = np.nanmean(np.nanmean(s2_con_firststopstorenbeac[0:5,:,:], axis =0), axis = 0)
con_probe1_w1 = np.nanmean(np.nanmean(s2_con_firststopstoreprobe[0:5,:,:], axis = 0), axis = 0)
sd_con_beac1_w1 = np.nanstd(np.nanmean(s2_con_firststopstorebeac[0:5,:,:], axis = 0), axis = 0)/math.sqrt(8)
sd_con_nbeac1_w1 = np.nanstd(np.nanmean(s2_con_firststopstorenbeac[0:5,:,:], axis =0), axis = 0)/math.sqrt(8)
sd_con_probe1_w1 = np.nanstd(np.nanmean(s2_con_firststopstoreprobe[0:5,:,:], axis = 0), axis = 0)/math.sqrt(8)

con_beac1_w4 = np.nanmean(np.nanmean(s2_con_firststopstorebeac[15:20,:,:], axis = 0), axis = 0)
con_nbeac1_w4 = np.nanmean(np.nanmean(s2_con_firststopstorenbeac[15:20,:,:], axis =0), axis = 0)
con_probe1_w4 = np.nanmean(np.nanmean(s2_con_firststopstoreprobe[15:20,:,:], axis = 0), axis = 0)
sd_con_beac1_w4 = np.nanstd(np.nanmean(s2_con_firststopstorebeac[15:20,:,:], axis = 0), axis = 0)/math.sqrt(8)
sd_con_nbeac1_w4 = np.nanstd(np.nanmean(s2_con_firststopstorenbeac[15:20,:,:], axis =0), axis = 0)/math.sqrt(8)
sd_con_probe1_w4 = np.nanstd(np.nanmean(s2_con_firststopstoreprobe[15:20,:,:], axis = 0), axis = 0)/math.sqrt(8)
...
#plt.subplots_adjust(hspace = .35, wspace = .35,  bottom = 0.15, left = 0.07, right = 0.82, top = 0.92)
fig.savefig('Plots/Speed/AvgSpeed_Histogram' + '_0100.png',  dpi = 200)
plt.close()
...
fig.savefig('Plots/Speed/AvgSpeed_Histogram_week1' + '_0100.png',  dpi = 200)
plt.close()
...
plt.subplots_adjust(hspace = 1, wspace = 0.4,  bottom = 0.35, left = 0.12, right = 0.97, top = .8)
fig.savefig('Plots/Speed/AvgSpeed_Histogram_week4' + '_0100.png',  dpi = 200)
plt.close()
